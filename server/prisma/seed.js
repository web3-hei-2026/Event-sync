...
async function main() {
  ...
  await prisma.session.createMany({
    data: [
      ...
      },
      {
        ...
        endTime: new Date("2026-05-20T12:30:00Z"),
        eventId: event1.id,
        roomId: room.id,
      },
      {
        ...
        endTime: new Date("2026-05-20T15:30:00Z"),
        eventId: event1.id,
        roomId: room.id,
      },
    ],
  ...
  await prisma.session.createMany({
    data: [
      ...
      {
        title: "Steel Mentality Branding",
        startTime: new Date("2026-06-15T13:30:00Z"),
  ...
  console.log(
    "✅ Données précises insérées : Event 1 (3 sessions) / Event 2 (2 sessions)",
  );
}
